...
export class HomeComponent implements OnInit {
    ...
    public trackCoinData: any;
  	...
  	ngOnInit() {
	  	jQuery('#coin_widget').html('<div class="cmw-widget-icocoin" data-ticker="KWH" style="font-size:18px;max-width:320px;min-width:320px"></div><script type="text/javascript" src="/assets/js/ico-widget.js"></script>');
